...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A growing collection of of my professional/personal projects, endeavors, and initiatives",
          section: "Navigation",
          handler: () => {
          ...
          title: "repositories",
          description: "Projects - n8n, Python, portfolio site, SQL Spatial, PMO Design",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-discord-server-project-management-achievers",
